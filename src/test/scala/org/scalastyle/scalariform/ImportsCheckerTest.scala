...
class ImportOrderCheckerTest extends AssertionsForJUnit with CheckerTest {
  ...
  @Test def testImportGrouping(): Unit = {
    ...
    val expected = List(
      ...
      columnError(7, 0, errorKey = errorKey("missingEmptyLine"), args = List("java", "scala")),
      columnError(11, 0, errorKey = errorKey("wrongOrderInGroup"),
        args = List("my.org.project1.MyClass", "org.apache.Foo")),
      columnError(15, 0, errorKey = errorKey("tooManyEmptyLines"),
        args = List("2", "others", "project2")),
      columnError(16, 0, errorKey = errorKey("wrongGroup"),
