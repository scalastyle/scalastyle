...
case class PositionError(position: Int, args: List[String] = Nil, errorKey: Option[String] = None) extends ScalastyleError
case class FileError(args: List[String] = Nil, errorKey: Option[String] = None) extends ScalastyleError
case class LineError(line: Int, args: List[String] = Nil, errorKey: Option[String] = None) extends ScalastyleError
case class ColumnError(line: Int, column: Int, args: List[String] = Nil, errorKey: Option[String] = None) extends ScalastyleError
